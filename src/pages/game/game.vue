...
export default {
  ...
  onShareAppMessage(){
    return {
      ...
      imageUrl:"https://game.gtimg.cn/images/wslg/cp/a20211221dgqyj/wx-share.jpg",
...
<style lang="scss" scoped>
  .page{
    ...
    width: 100%;
    min-height: 100vh;
    background: url(https://game.gtimg.cn/images/wslg/cp/a20211221dgqyj/bg2.jpg) no-repeat top;
    ...
    .btn-rule{
      width: 150upx;
      height: 66upx;
      background: url(https://game.gtimg.cn/images/wslg/cp/a20211221dgqyj/btn-rule.png) no-repeat center/100%;
      display: block;
    }
    .btn-my-reward{
      width: 150upx;
      height: 66upx;
      background: url(https://game.gtimg.cn/images/wslg/cp/a20211221dgqyj/btn-my-reward.png) no-repeat center/100%;
      display: block;
    }
    .btn-invite{
      display: block;
      width: 439upx;
      height: 114upx;
      background: url(https://game.gtimg.cn/images/wslg/cp/a20211221dgqyj/btn-invite.png) no-repeat center/100%;
    }
  }
</style>
